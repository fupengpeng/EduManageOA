...
import com.jdlx.edumanageoa.customerview.ProgressDialog;
...
public class DialogUtils {
     ...
     * @return
     */
    public Dialog alert(CharSequence title, CharSequence message,DialogInterface.OnClickListener confirmListener) {
        Builder builder = new Builder(context);
        builder.setTitle(title);
        builder.setMessage(message);
